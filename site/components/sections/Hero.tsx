...
const heroFeatureIcons = [ShieldCheck, ChefHat, Users];
      ...
      <Container className="relative z-10">
        <div className="max-w-xl">
          <h1 className="hero-anim font-display text-4xl font-bold leading-[1.05] tracking-tight sm:text-5xl lg:text-[60px] lg:leading-[63px] lg:tracking-[-1.5px]">
            <span className="block text-(--color-cream)">{t.hero.titleLine1}</span>
            <span className="block text-(--color-primary-tint)">{t.hero.titleLine2}</span>
          </h1>
